...
public abstract class TestArticleSearchService extends TestStoreBase {
	...
	public void testFindRelatedArticles() throws StoreException, SearchException {
		...
		ArticleKey path1 = Utils.updateArticle(articleStore, site, "1", "http://www.abc.de/1", 2010, 1, 12, "Title", TEXT);
		ArticleKey path2 = Utils.updateArticle(articleStore, site, "2", "http://www.abc.de/2", 2010, 1, 12, "Title", SCORE2);
		ArticleKey path3 = Utils.updateArticle(articleStore, site, "3", "http://www.abc.de/3", 2010, 1, 12, "Title", SCORE1);
		Utils.updateArticle(articleStore, site2, "4", "http://www.xyz.de/4", 2010, 1, 12, "Title", SCORE3);
		ArticleKey path5 = Utils.updateArticle(articleStore, site, "5", "http://www.abc.de/5", 2010, 1, 12, "Title", SCORE5);
